...
추가 인프런 강의 https://inf.run/eMLQ 참고


# 진행방식

발표자 : 모임날마다 바뀐다. 발표순서는 | 이동근 - 방장원 - 송진세 - 최상훈 - 장근영 | 로테이션

모이는날: 새싹 영등포 캠퍼스 오는 날(월수금) 주3회, 수업7시 마친 이후 or 수업이전 (사전회의)
